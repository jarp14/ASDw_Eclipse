 ...
 * @generated
 */
public class SoothingObjectNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.SoothingObjectNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SoothingObjectNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.SoothingObject_3010, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.SoothingObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SoothingObjectLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SoothingObjectLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SoothingObjectLabelFigure() {
			this.setText("SoothingObject");
		}
