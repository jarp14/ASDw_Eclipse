 ...
 * @generated
 */
public class PlanningNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PlanningNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Planning_2002, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PlanningNameEditPart.VISUAL_ID));
		}
		return parser;
	}
