 ...
 * @generated
 */
public class PrizeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PrizeNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public PrizeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Prize_3007, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PrizeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PrizeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PrizeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PrizeLabelFigure() {
			this.setText("Prize");
		}
