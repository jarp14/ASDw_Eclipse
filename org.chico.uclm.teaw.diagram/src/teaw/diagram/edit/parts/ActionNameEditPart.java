 ...
 * @generated
 */
public class ActionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.ActionNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Action_3004, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.ActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
