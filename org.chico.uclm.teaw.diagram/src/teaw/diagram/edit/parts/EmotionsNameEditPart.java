 ...
 * @generated
 */
public class EmotionsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmotionsNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return TeawElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Emotions_2001, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.EmotionsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
