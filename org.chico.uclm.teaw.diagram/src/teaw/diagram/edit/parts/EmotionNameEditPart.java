 ...
 * @generated
 */
public class EmotionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.EmotionNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EmotionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Emotion_3002, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.EmotionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EmotionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EmotionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EmotionLabelFigure() {
			this.setText("Emotion");
		}
