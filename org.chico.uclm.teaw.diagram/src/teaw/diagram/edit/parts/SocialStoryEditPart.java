...
import org.chico.uclm.teaw.figures.StoryFigure;
 ...
 * @generated
 */
public class SocialStoryEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public SocialStoryEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SocialStoryItemSemanticEditPolicy());
	...
	* @generated
	*/
	public SocialStoryFigure getPrimaryShape() {
		return (SocialStoryFigure) primaryShape;
	}
		...
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttribute) {
				...
				if (eAttribute.getName().equalsIgnoreCase("imagePath")) {
					StoryFigure figure = (StoryFigure) this.getPrimaryShape();
