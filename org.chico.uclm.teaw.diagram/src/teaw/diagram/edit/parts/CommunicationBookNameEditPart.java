 ...
 * @generated
 */
public class CommunicationBookNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.CommunicationBookNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CommunicationBookNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.CommunicationBook_3009, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.CommunicationBookNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CommunicationBookLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CommunicationBookLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CommunicationBookLabelFigure() {
			this.setText("CommunicationBook");
		}
