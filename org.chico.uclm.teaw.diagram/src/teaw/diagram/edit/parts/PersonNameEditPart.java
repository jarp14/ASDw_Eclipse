 ...
 * @generated
 */
public class PersonNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PersonNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Person_3003, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PersonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
