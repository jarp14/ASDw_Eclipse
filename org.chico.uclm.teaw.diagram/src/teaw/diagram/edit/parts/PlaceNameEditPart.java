 ...
 * @generated
 */
public class PlaceNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PlaceNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.Place_3005, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.PlaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PlaceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PlaceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PlaceLabelFigure() {
			this.setText("Place");
		}
