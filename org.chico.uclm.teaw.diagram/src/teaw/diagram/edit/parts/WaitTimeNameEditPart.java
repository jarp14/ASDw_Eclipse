...
import teaw.diagram.edit.policies.TeawTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WaitTimeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.WaitTimeNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public WaitTimeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new TeawTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.WaitTime_3006, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.WaitTimeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, TeawEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new WaitTimeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class WaitTimeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public WaitTimeLabelFigure() {
			this.setText("WaitTime");
		}
