 ...
 * @generated
 */
public class EmotionChoiceNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.EmotionChoiceNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EmotionChoiceNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.EmotionChoice_3001, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.EmotionChoiceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EmotionChoiceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EmotionChoiceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EmotionChoiceLabelFigure() {
			this.setText("EmotionChoice");
		}
