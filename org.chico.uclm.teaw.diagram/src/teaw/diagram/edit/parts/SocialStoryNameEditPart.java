 ...
 * @generated
 */
public class SocialStoryNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.SocialStoryNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SocialStoryNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TeawParserProvider.getParser(TeawElementTypes.SocialStory_3008, getParserElement(),
					TeawVisualIDRegistry.getType(teaw.diagram.edit.parts.SocialStoryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SocialStoryLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SocialStoryLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SocialStoryLabelFigure() {
			this.setText("SocialStory");
		}
