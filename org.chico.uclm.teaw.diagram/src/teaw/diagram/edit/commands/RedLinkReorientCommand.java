 ...
 * @generated
 */
public class RedLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RedLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RedLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return TeawBaseItemSemanticEditPolicy.getLinkConstraints().canExistRedLink_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Emotions container = (Emotions) getLink().eContainer();
		return TeawBaseItemSemanticEditPolicy.getLinkConstraints().canExistRedLink_4002(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected RedLink getLink() {
		return (RedLink) getElementToEdit();
	}
