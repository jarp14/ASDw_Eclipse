...
import teaw.diagram.expressions.TeawOCLFactory;
 ...
 * @generated
 */
public class TeawBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected TeawBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(TeawVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = TeawElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = TeawDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			TeawDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateNormalLink_4001(Planning container, Picto source, Picto target) {
			return canExistNormalLink_4001(container, null, source, target);
		}
		...
		public boolean canCreateGreenLink_4003(Emotions container, EmotionChoice source, Emotion target) {
			...
			return canExistGreenLink_4003(container, null, source, target);
		}
			...
			try {
				if (source == null) {
					...
					Map<String, EClassifier> env = Collections.<String, EClassifier>singletonMap("oppositeEnd", //$NON-NLS-1$
							TeawPackage.eINSTANCE.getPicto());
					Object sourceVal = TeawOCLFactory.getExpression(0, TeawPackage.eINSTANCE.getPicto(), env)
				...
				if (target == null) {
					...
					Map<String, EClassifier> env = Collections.<String, EClassifier>singletonMap("oppositeEnd", //$NON-NLS-1$
							TeawPackage.eINSTANCE.getPicto());
					Object targetVal = TeawOCLFactory.getExpression(1, TeawPackage.eINSTANCE.getPicto(), env)
				...
				TeawDiagramEditorPlugin.getInstance().logError("Link constraint evaluation error", e); //$NON-NLS-1$
				return false;
			}
		}
