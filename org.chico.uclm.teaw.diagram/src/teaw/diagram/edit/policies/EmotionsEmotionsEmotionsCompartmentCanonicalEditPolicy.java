 ...
 * @generated
 */
public class EmotionsEmotionsEmotionsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return TeawPackage.eINSTANCE.getEmotions_Emotions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<TeawNodeDescriptor> childDescriptors = TeawDiagramUpdater
				.getEmotionsEmotionsEmotionsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<TeawNodeDescriptor> childDescriptors = TeawDiagramUpdater
				.getEmotionsEmotionsEmotionsCompartment_7001SemanticChildren((View) getHost().getModel());
